    ...
    'nav' => array(    // replace ID-SECTION with the id of the section (don't use space, only "-" for the space)
        ...
        'options' => array(
            ...
            'subnav-color' => array(    // replace ID-OPTION with the id of this option (don't use space, only "-" for the space) 
                ...
                'panel_desc'  => __( "Select the color of each item in submenu. (default #010101)", 'yiw' )  // the description of option for Theme Options
            ),
	...
	'store-buttons' => array(    
		...
		'options' => array( 
			...
			'store-buttons-alt-bg' => array(    
				'default' => '#7FA92D',
				'css_role' => 'a.button-alt, a.button.alt, input.button-alt, button.button.alt, button.button-alt, input.button.alt, #review_form #submit.alt', 
				'css_attr' => 'background-color', 
			...
			'store-buttons-alt-bg-hover' => array(    
				'default' => '#8ab830',
				'css_role' => 'a.button-alt:hover, a.button.alt:hover, input.button-alt:hover, button.button.alt:hover, button.button-alt:hover, input.button.alt:hover, #review_form #submit.alt:hover', 
				'css_attr' => 'background-color', 
    ...
    'footer' => array(
        ...
        'options' => array(
			...
			'footer-color-titles' => array(    
				...
				'panel_desc' => __( "The color of all titles of the footer (default #232221).", 'yiw' ) 
			),
			...
			'footer-color-menues-links' => array(    
				...
				'panel_desc' => __( "The color of links of menues, of the footer (default #545252).", 'yiw' ),
                'important' => true  
			),
			...
			'footer-color-menues-links-hover' => array(    
				...
				'panel_desc' => __( "The color of links of menues in hover state, of the footer (default #9A6614).", 'yiw' ),
                'important' => true   
			),     
