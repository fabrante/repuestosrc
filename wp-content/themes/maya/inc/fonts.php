...
$yiw_fonts = array(
    ...
    array(
        'id_option' => 'font_p',
        'css_role' => 'p, p a, .unoslider_caption, .comment-body, .comment-body p, #comments .fn, .cart span, .shop_table span, .shop_table th, .shop_table td',
    ),    
    array(
        'id_option' => 'font_h1',
        'css_role' => 'h1, h1 a',
    ...
    array(
        ...
        'css_role' => '#slider .slider-nivo-static h3, .slider-minilayers-static h3',
    ),       
    array(
    ...
    array(
        'id_option' => 'font_nivo_content',
        'css_role' => '#slider .slider-nivo-static p'
    ),      
);
