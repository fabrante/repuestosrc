...
$yiw_options['typography'] = array (
    ...
    "typography" => array(    
        ...
        array( "name" => __("Paragraphs font", 'yiw'),
               "desc" => __("Select the type to use for the paragraphs (default Calibri).", 'yiw'),
               "id" => "font_p",
               "type" => "font-select",
               "data" => "array",
               "font-types" => 'google-font,web-fonts',
               "std" => array( 'type' => 'web-fonts', 'web-fonts' => "'Calibri', 'Droid Sans', Verdana, Arial sans-serif" ) ),  
        ...
        array( "name" => __( "Slider Nivo and MiniLayer: Content font", "yiw" ),
               "desc" => __( "Select the type to use for Slider Nivo and MiniLayer content (default Calibri).", 'yiw'),
