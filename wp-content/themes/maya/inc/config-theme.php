...
define( 'NOTIFIER_XML_FILE', 'http://www.niubbys.altervista.org/maya.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
