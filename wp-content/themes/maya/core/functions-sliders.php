...
function yiw_can_show_slider() {
    ...
    global $wp_query;
    $can = (bool) ( ! $wp_query->is_posts_page && ( is_page() || is_home() || ( is_post_type_archive( 'product' ) && get_page_template_slug( get_option('woocommerce_shop_page_id') ) == 'home.php' ) ) && ! is_search() );
