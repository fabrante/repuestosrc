        ...
        <div id="slider" class="ei-slider elastic<?php if ( yiw_get_option( 'slider_responsive' ) != 'leave' ) : ?> not-for-mobile<?php endif; ?>">
            ...
            <ul class="ei-slider-large">
                ...
                <?php while( yiw_have_slide() ) : 
                    ...
                    $thumbs .= "<li><a href=\"#\">".strip_tags(yiw_slide_get( 'slide_title' ))." - ".strip_tags(yiw_slide_get( 'clean-content' ))."</a><img src=\"$thumbnail\" alt=\"".strip_tags(yiw_slide_get( 'slide_title' ))." - ".strip_tags(yiw_slide_get( 'clean-content' ))."\" /></li>\n"; ?>
